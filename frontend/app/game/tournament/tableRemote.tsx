...
export default function Table({Name , socket}) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      socketRef.current.onopen = () => {
        ...
        console.log ('ty:', typeof Name);
        console.log ('name:', Name);
        const firtsData = { username: Name,
                            ...
                            socket.current.send(JSON.stringify({ type: 'matchmaking', data: firtsData }));
      };
