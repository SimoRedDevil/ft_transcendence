...
export  default async function Profile ()
{
    ...
    return(
        <div className=' lg:w-[85%]  lg:h-[80vh] flex flex-col items-center justify-center lg:relative lg:left-[8%] xs:gap-8 xs:relative lg:top-10 lg:gap-[5%] xs:h-auto xs:hide-scrollbar xs:overflow-auto xs:w-full'>
            <div className=' flex justify-between items-center  lg:h-[30%] lg:w-[95%] lg:flex-row xs:flex-col xs:h-auto xs:w-[95%] xs:gap-8 '>
            ...
            <div className='flex justify-between items-center  lg:flex-row lg:h-[55%] lg:w-[95%] xs:flex-col xs:h-[100vh] xs:w-[95%] xs:gap-8  pb-8'>
