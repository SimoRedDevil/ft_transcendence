        ...
        <div className="border-[0.5px] border-white flex sm:h-[85%] laptop:w-[75%] rounded-[50px] border-opacity-40
            ...
            <div className=" flex items-center justify-around desktop:w-[73%] desktop:h-[100px]
                ...
                className={` tablet:bg-[#D9D9D9] bg-opacity-10 rounded-l-[50px]
                    ...
                    `}>
                    <IoIosInformationCircle className="desktop:w-[45px] desktop:h-[45px] text-white tablet:mr-1 laptop:mr-2 hidden
                ...
                `}>
                    <FaFlag className="desktop:w-[45px] desktop:h-[45px] text-white tablet:mr-1 laptop:mr-2 hidden
                      mobile:w-[30px] mobile:h-[30px] h-[20px] w-[20px]" />
                ...
                `}>
                    <PiLockKeyFill className="desktop:w-[45px] desktop:h-[45px] text-white tablet:mr-1 laptop:mr-2 hidden
                      mobile:w-[30px] mobile:h-[30px] h-[20px] w-[20px]" />
            ...
            `}>
                    <TfiLayoutGrid3Alt className="desktop:w-[30px] desktop:h-[30px] text-white tablet:mr-1 laptop:mr-2 hidden
