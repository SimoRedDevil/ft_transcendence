...
function GameMode (info : any) {
    return(
         ...
         <div    className="flex flex-col justify-center items-center h-[42%] w-[96%] rounded-3xl bg-cover bg-center bg-black bg-opacity-60 bg-blend-overlay border_cus_mode hover:bg-opacity-0 hover:cursor-pointer " 
