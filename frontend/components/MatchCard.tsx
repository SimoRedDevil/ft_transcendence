    ...
    return(
        <div className=" w-full h-full flex justify-between items-center">
                <div className="h-full flex flex-col justify-center items-center ">
                    <img className="xl:w-12  xl:h-12 lg:w-8 lg:h-8  rounded-full border-2 border-[#00FFF0]" src={main_user_avatar} alt="" />
                ...
                <div className="relative flex flex-col justify-center items-center top-2 ">
                        ...
                        <div className="flex justify-center items-center gap-1  absolute  match_result_  lg:w-[90px] lg:h-[25px] xl:w-[120px] xl:h-[30px]">
                ...
                <div className="h-full flex flex-col justify-center items-center ">
                    <img className="xl:w-12  xl:h-12 lg:w-8 lg:h-8  rounded-full border-2 border-[#00FFF0]" src={img} alt="" />
