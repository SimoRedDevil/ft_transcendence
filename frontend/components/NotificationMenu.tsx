                ...
                <div key={notification?.id}>
                  {
                    ...
                    <NotificationElement Url='/friend-requests/' Avatar={notification?.sender_info.avatar_url} FullName={notification?.sender_info.full_name} Description={notification?.description} Date={notification?.get_human_readable_time} Key={notification?.id} IsRead={notification?.is_read} />
                  }
                  {
