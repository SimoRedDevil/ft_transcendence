...
//                             <button onClick={
//                                 () => {
//                                     ws.send(JSON.stringify({"notif_type": "reject_game", "sender": receiver.username, "receiver": sender.username,
...
//                             <button onClick={
//                                 () => {
//                                     ws.send(JSON.stringify({"notif_type": "accept_game", "sender": receiver.username, "receiver": sender.username,
//                                 "title": "Accept Game", "description": "I accept your game invitation"
//                                 }));
//                                 const query = new URLSearchParams({
//                                     type: 'invite',
